...
export default function ControlsPage() {
  ...
  const enhanceWithAI = async () => {
    ...
    try {
      ...
      alert('AI enhancement failed. Check console for details.');
    } finally {
      setLoadingAI(false);
    }
  };
          ...
          <div>
            {result ? (
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-xl border-2 border-slate-200 p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-4xl font-bold text-purple-600">{result.overall_score}</div>
                ...
                {/* AI Enhancement Section - EXACT MATCH FROM ETs */}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-0.5 bg-purple-200 text-purple-700 text-xs font-semibold rounded">Beta</span>
                        </div>
