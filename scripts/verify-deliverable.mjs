...
// Mirrors the validate route: content-first guard only. The prior second
// step (downgradeSynthesizedResponseAutos) was removed once runFixPipeline
// learned to synthesise ParaState-only CellStates from a marketing doc's
// `q.response.responseParagraphs`, so DM response autos now emit real
// <w:del>+<w:ins> tracked changes on the paragraph rather than becoming
// comments. See app/gn-validator/output/fix-pipeline.ts.
